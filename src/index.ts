...
import { convertToOembed, escapeHtml, genHtmlBlock, getAll, getCurrentBlock, isEmptyParagraphBlock, isHTMLBlock, isParagraphBlock } from "@/utils/utils"
import "@/index.scss";
...
export default class OembedPlugin extends Plugin {
            ...
            toolbar: [...builtinEditTools,
                {
                    ...
                    click: (protyle: Protyle) => {
                        ...
                        console.log("🚀 ~ OembedPlugin ~ callback ~ getCurrentBlock:", getCurrentBlock())
                        console.log("🚀 ~ OembedPlugin ~ callback ~ isEmptyParagraphBlock:", isEmptyParagraphBlock())
                        console.log("🚀 ~ OembedPlugin ~ callback ~ isParagraphBlock:", isParagraphBlock())
                        console.log("🚀 ~ OembedPlugin ~ callback ~ isHTMLBlock:", isHTMLBlock())
    ...
    private blockIconEvent({ detail }: any) {
        ...
        detail.menu.addItem({
            ...
            click: () => {
                console.log("🚀 ~ OembedPlugin ~ click ~ detail:", detail.blockElements)
                const promises = detail.blockElements.map(async (item: HTMLElement) => {
                    await convertToOembed(item, detail.protyle.getInstance());
                });
